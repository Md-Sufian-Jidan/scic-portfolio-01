                    ...
                    <div className="flex flex-col items-center justify-between md:flex-row">
                        ...
                        <div className="flex mt-4 md:m-0">
                            <div className="-mx-4">
                                ...
                                <a href="#" className="px-4 text-sm text-gray-600 transition-colors duration-300 dark:text-gray-200 hover:text-blue-500 dark:hover:text-blue-400 hover:underline">Skills</a>
                                <a href="#" className="px-4 text-sm text-gray-600 transition-colors duration-300 dark:text-gray-200 hover:text-blue-500 dark:hover:text-blue-400 hover:underline">Project</a>
